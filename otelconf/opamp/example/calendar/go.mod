module go.opentelemetry.io/contrib/otelconf/opamp/example/calendar
...
require (
	...
	go.opentelemetry.io/contrib/otelconf/opamp v0.1.0
...
// Unpublished contrib modules used by this example resolve to local source.
replace go.opentelemetry.io/contrib/otelconf/opamp => ../..

replace go.opentelemetry.io/contrib/otelconf => ../../..
